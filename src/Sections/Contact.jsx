          ...
          >
            <form ref={formRef} onSubmit={sendEmail} className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <textarea name="message" id="message" required rows="5" className="w-full px-4 py-3 bg-zinc-900 border border-zinc-800 text-white focus:outline-none focus:border-cinema-red transition-colors resize-none" placeholder="Tell me about your project..."></textarea>
              </div>
